...
public class RVAdapter2 extends RecyclerView.Adapter<ItemViewHolder> {
    ...
    public RVAdapter2(List<CountryModel> mCountryModel) {
    ...
    public void onBindViewHolder(final ItemViewHolder itemViewHolder, int i) {
        ...
        itemViewHolder.starOOF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                doProcess(model.getId(), model.getThai(),model.getEnglish(),"true");
